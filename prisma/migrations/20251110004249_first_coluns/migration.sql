...
-- AddForeignKey
ALTER TABLE "Appointments" ADD CONSTRAINT "Appointments_servicesID_fkey" FOREIGN KEY ("servicesID") REFERENCES "Service"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
